class Node:
    def __init__(self, index, op_type, inputs, outputs):
        ...
        self.inputs = inputs  # List of dictionaries with 'name' and 'shape'
        self.outputs = outputs  # List of dictionaries with 'name' and 'shape'

class MyGraph:
    def __init__(self):
        self.nodes = []
        self.graphinput = []  # Initialize graphinput
        self.graphoutput = []  # Initialize graphoutput
