...
def sort(ifile_path,ofile_path):
    ...
    while finished_flag == 0:
            ...
            for i in range(graph_num):
                ...
                for g_input in graphs_inputs[i]:
                    for j in range(graph_num):
                        #print(g_input)
                        # print(graphs_outputs[j])
                        # print(len(graphs_outputs))
        ...
        for i in range(graph_num):
            ...
            f2.write(content)
        f2.close()
#rename_subgraph_node_ios('subgraphs/subgraphs_cpu','subgraphs/subgraphs_cpu_renamed')
#rename_subgraph_node_ios('subgraphs/subgraphs_npu','subgraphs/subgraphs_npu_renamed')
# print_model('net/diffusion_model_fp32_with_shape.onnx')
# print_model('net/unet_32_sim.onnx')