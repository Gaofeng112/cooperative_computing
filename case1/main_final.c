...
int main(int argc, char **argv) {
    ...
    int input_size_npu_Subgraphs_0[] = {1 * 4 * 64 * 64, };
    ...
    input_tensors_npu_Subgraphs_0[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_0[0]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_0[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_0[1]->dim[2] = 64;
    output_tensors_npu_Subgraphs_0[1]->dim[3] = 64;
   ...
   /******************npu_Subgraphs_1**************************/
    ...
    int input_size_npu_Subgraphs_1[] = {1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_1[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_1[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_1[0]->dim[3] = 64;
    ...
    input_tensors_cpu_Subgraphs_0[0]->dim[2] = 64;
    input_tensors_cpu_Subgraphs_0[0]->dim[3] = 64;
    ...
    output_tensors_cpu_Subgraphs_0[0]->dim[2] = 40960;
    ...
    int input_size_npu_Subgraphs_2[] = {1 * 320 * 64 *64, 1 * 32 * 40960 };
    ...
    input_tensors_npu_Subgraphs_2[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_2[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_2[1]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_2[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_2[0]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_2[1]->dim[2] = 40960;
    ...
    int input_size_npu_Subgraphs_3[] = {1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_3[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_3[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_3[0]->dim[3] = 64;
    ...
    input_tensors_cpu_Subgraphs_1[0]->dim[2] = 64;
    input_tensors_cpu_Subgraphs_1[0]->dim[3] = 64;
    ...
    output_tensors_cpu_Subgraphs_1[0]->dim[2] = 64;
    output_tensors_cpu_Subgraphs_1[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_4[] = {1 * 320 *64 * 64, 1 * 320 *64 * 64};
    ...
    input_tensors_npu_Subgraphs_4[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_4[0]->dim[3] = 64;
    //Add_1_output_0
    ...
    input_tensors_npu_Subgraphs_4[1]->dim[2] = 64;
    input_tensors_npu_Subgraphs_4[1]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_4[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_4[0]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_4[1]->dim[2] = 32;
    output_tensors_npu_Subgraphs_4[1]->dim[3] = 32;
    ...
    output_tensors_npu_Subgraphs_4[2]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_4[3]->dim[2] = 32;
    output_tensors_npu_Subgraphs_4[3]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_5[] = {1 * 32 * 10240, 1 * 1280, };
    ...
    input_tensors_npu_Subgraphs_5[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_5[0]->dim[2] = 20480;
    ...
    int input_size_npu_Subgraphs_6[] = {1 * 640 * 32 * 32, 1 * 32 * 20480 };
    ...
    input_tensors_npu_Subgraphs_6[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_6[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_6[1]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_6[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_6[1]->dim[2] = 32;
    output_tensors_npu_Subgraphs_6[1]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_7[] = {1 * 32 * 20480, };
    ...
    input_tensors_npu_Subgraphs_7[0]->dim_count = 4;
    input_tensors_npu_Subgraphs_7[0]->dim[0] = 1;
    input_tensors_npu_Subgraphs_7[0]->dim[1] = 640;
    input_tensors_npu_Subgraphs_7[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_7[0]->dim[3] = 32;
    ...
    output_tensors_npu_Subgraphs_7[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_7[0]->dim[3] = 32;
    ...
    input_tensors_cpu_Subgraphs_2[0]->dim[2] = 64;
    input_tensors_cpu_Subgraphs_2[0]->dim[3] = 64;
    ...
    output_tensors_cpu_Subgraphs_2[0]->dim[2] = 32;
    output_tensors_cpu_Subgraphs_2[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_8[] = {1 * 640 * 32 * 32, 1 * 640 * 32 * 32,  };
    ...
    input_tensors_npu_Subgraphs_8[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_8[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_8[1]->dim[2] = 32;
    input_tensors_npu_Subgraphs_8[1]->dim[3] = 32;
    //0_Add_1_output_0
    ...
    output_tensors_npu_Subgraphs_8[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_8[0]->dim[3] = 32;
    ...
    output_tensors_npu_Subgraphs_8[1]->dim[2] = 16;
    output_tensors_npu_Subgraphs_8[1]->dim[3] = 16;
    ...
    output_tensors_npu_Subgraphs_8[2]->dim[2] = 5120;
    ...
    int input_size_npu_Subgraphs_9[] = {1 * 32 * 5120, 1 * 1280, };
    ...
    input_tensors_npu_Subgraphs_9[0]->dim[2] = 5120;
    ...
    output_tensors_npu_Subgraphs_9[0]->dim[2] = 10240;
    ...
    int input_size_npu_Subgraphs_10[] = {1 * 640 * 16 * 16, 1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_10[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_10[0]->dim[3] = 16;
    ...
    input_tensors_npu_Subgraphs_10[1]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_10[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_10[1]->dim[2] = 16;
    output_tensors_npu_Subgraphs_10[1]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_11[] = {1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_11[0]->dim[2] = 1024;
    ...
    output_tensors_npu_Subgraphs_11[0]->dim[2] = 16;
    output_tensors_npu_Subgraphs_11[0]->dim[3] = 16;
    ...
    input_tensors_cpu_Subgraphs_3[0]->dim[2] = 16;
    input_tensors_cpu_Subgraphs_3[0]->dim[3] = 16;
    ...
    output_tensors_cpu_Subgraphs_3[0]->dim[2] = 16;
    output_tensors_cpu_Subgraphs_3[0]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_12[] = {1 * 1280 * 16 * 16, 1 * 1280 * 16 * 16, };
    ...
    input_tensors_npu_Subgraphs_12[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_12[0]->dim[3] = 16;
    //Add_1_output_0
    ...
    input_tensors_npu_Subgraphs_12[1]->dim[2] = 16;
    input_tensors_npu_Subgraphs_12[1]->dim[3] = 16;
    ...
    output_tensors_npu_Subgraphs_12[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_12[1]->dim[2] = 16;
    output_tensors_npu_Subgraphs_12[1]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_13[] = {1 * 32 * 20480, 1 * 1280, };
    ...
    input_tensors_npu_Subgraphs_13[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_13[0]->dim[2] = 10240;
    ...
    int input_size_npu_Subgraphs_14[] = {1 * 1280 * 16 * 16, 1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_14[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_14[0]->dim[3] = 16;
    ...
    input_tensors_npu_Subgraphs_14[1]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_14[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_14[1]->dim[2] = 16;
    output_tensors_npu_Subgraphs_14[1]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_15[] = {1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_15[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_15[0]->dim[2] = 16;
    output_tensors_npu_Subgraphs_15[0]->dim[3] = 16;
    ...
    input_tensors_cpu_Subgraphs_4[0]->dim[2] = 16;
    input_tensors_cpu_Subgraphs_4[0]->dim[3] = 16;
    ...
    output_tensors_cpu_Subgraphs_4[0]->dim[2] = 16;
    output_tensors_cpu_Subgraphs_4[0]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_16[] = {1 * 1280 * 16 * 16, 1 * 1280 * 16 * 16, };
    ...
    input_tensors_npu_Subgraphs_16[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_16[0]->dim[3] = 16;
    ...
    input_tensors_npu_Subgraphs_16[1]->dim[2] = 16;
    input_tensors_npu_Subgraphs_16[1]->dim[3] = 16;
    ...
    output_tensors_npu_Subgraphs_16[0]->dim[2] = 16;
    output_tensors_npu_Subgraphs_16[0]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_17[] = {1 * 32 * 15360, 1 * 1280, };
    ...
    input_tensors_npu_Subgraphs_17[0]->dim[2] = 15360;
    ...
    output_tensors_npu_Subgraphs_17[0]->dim[2] = 10240;
    ...
    int input_size_npu_Subgraphs_18[] = {1 * 1920 * 16 * 16, 1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_18[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_18[0]->dim[3] = 16;
    ...
    input_tensors_npu_Subgraphs_18[1]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_18[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_18[1]->dim[2] = 16;
    output_tensors_npu_Subgraphs_18[1]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_19[] = {1 * 32 * 10240, };
    ...
    input_tensors_npu_Subgraphs_19[0]->dim[2] = 10240;
    ...
    output_tensors_npu_Subgraphs_19[0]->dim[2] = 16;
    output_tensors_npu_Subgraphs_19[0]->dim[3] = 16;
    ...
    input_tensors_cpu_Subgraphs_5[0]->dim[2] = 16;
    input_tensors_cpu_Subgraphs_5[0]->dim[3] = 16;
    ...
    output_tensors_cpu_Subgraphs_5[0]->dim[2] = 16;
    output_tensors_cpu_Subgraphs_5[0]->dim[3] = 16;
    ...
    int input_size_npu_Subgraphs_20[] = {1 * 1280 * 16 * 16, 1 * 1280 * 16 * 16, };
    ...
    input_tensors_npu_Subgraphs_20[0]->dim[2] = 16;
    input_tensors_npu_Subgraphs_20[0]->dim[3] = 16;
    ...
    input_tensors_npu_Subgraphs_20[1]->dim[2] = 16;
    input_tensors_npu_Subgraphs_20[1]->dim[3] = 16;
    ...
    output_tensors_npu_Subgraphs_20[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_20[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_22[] = {1 * 32 * 61440, };
    ...
    input_tensors_npu_Subgraphs_22[0]->dim[2] = 61440;
    ...
    output_tensors_npu_Subgraphs_22[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_22[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_23[] = {1 * 1920 * 32 * 32, 1 * 32 * 20480, };
    ...
    input_tensors_npu_Subgraphs_23[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_23[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_23[1]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_23[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_23[1]->dim[2] = 32;
    output_tensors_npu_Subgraphs_23[1]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_24[] = {1 * 32 * 20480, };
    ...
    input_tensors_npu_Subgraphs_24[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_24[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_24[0]->dim[3] = 32;
    ...
    input_tensors_cpu_Subgraphs_6[0]->dim[2] = 32;
    input_tensors_cpu_Subgraphs_6[0]->dim[3] = 32;
    ...
    output_tensors_cpu_Subgraphs_6[0]->dim[2] = 32;
    output_tensors_cpu_Subgraphs_6[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_25[] = {1 * 640 * 32 * 32, 1 * 640 * 32 * 32, };
    ...
    input_tensors_npu_Subgraphs_25[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_25[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_25[1]->dim[2] = 32;
    input_tensors_npu_Subgraphs_25[1]->dim[3] = 32;
    ...
    output_tensors_npu_Subgraphs_25[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_25[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_27[] = {1 * 32 * 30720, };
    ...
    input_tensors_npu_Subgraphs_27[0]->dim[2] = 30720;
    ...
    output_tensors_npu_Subgraphs_27[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_27[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_28[] = {1 * 960 * 32 * 32, 1 * 32 * 20480, };
    ...
    input_tensors_npu_Subgraphs_28[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_28[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_28[1]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_28[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_28[1]->dim[2] = 32;
    output_tensors_npu_Subgraphs_28[1]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_29[] = {1 * 32 * 20480, };
    ...
    input_tensors_npu_Subgraphs_29[0]->dim[2] = 20480;
    ...
    output_tensors_npu_Subgraphs_29[0]->dim[2] = 32;
    output_tensors_npu_Subgraphs_29[0]->dim[3] = 32;
    ...
    input_tensors_cpu_Subgraphs_7[0]->dim[2] = 32;
    input_tensors_cpu_Subgraphs_7[0]->dim[3] = 32;
    ...
    output_tensors_cpu_Subgraphs_7[0]->dim[2] = 32;
    output_tensors_cpu_Subgraphs_7[0]->dim[3] = 32;
    ...
    int input_size_npu_Subgraphs_30[] = {1 * 640 * 32 * 32, 1 * 640 * 32 * 32, };
    ...
    input_tensors_npu_Subgraphs_30[0]->dim[2] = 32;
    input_tensors_npu_Subgraphs_30[0]->dim[3] = 32;
    ...
    input_tensors_npu_Subgraphs_30[1]->dim[2] = 32;
    input_tensors_npu_Subgraphs_30[1]->dim[3] = 32;
    ...
    output_tensors_npu_Subgraphs_30[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_30[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_32[] = {1 * 32 * 122880, };
    ...
    input_tensors_npu_Subgraphs_32[0]->dim[2] = 122880;
    ...
    output_tensors_npu_Subgraphs_32[0]->dim[1] = 640;
    output_tensors_npu_Subgraphs_32[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_32[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_33[] = {1 * 960 * 64 * 64, 1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_33[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_33[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_33[1]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_33[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_33[1]->dim[2] = 64;
    output_tensors_npu_Subgraphs_33[1]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_34[] = {1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_34[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_34[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_34[0]->dim[3] = 64;
    ...
    input_tensors_cpu_Subgraphs_8[0]->dim[2] = 64;
    input_tensors_cpu_Subgraphs_8[0]->dim[3] = 64;
    ...
    output_tensors_cpu_Subgraphs_8[0]->dim[2] = 64;
    output_tensors_cpu_Subgraphs_8[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_35[] = {1 * 320 * 64 * 64, 1 * 320 * 64 * 64, };
    ...
    input_tensors_npu_Subgraphs_35[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_35[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_35[1]->dim[2] = 64;
    input_tensors_npu_Subgraphs_35[1]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_35[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_35[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_37[] = {1 * 32 * 81920, };
    ...
    input_tensors_npu_Subgraphs_37[0]->dim[2] = 81920;
    ...
    output_tensors_npu_Subgraphs_37[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_37[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_38[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_38[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_38[1]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_38[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_38[1]->dim[2] = 64;
    output_tensors_npu_Subgraphs_38[1]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_39[] = {1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_39[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_39[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_39[0]->dim[3] = 64;
    ...
    input_tensors_cpu_Subgraphs_9[0]->dim[2] = 64;
    input_tensors_cpu_Subgraphs_9[0]->dim[3] = 64;
    ...
    output_tensors_cpu_Subgraphs_9[0]->dim[2] = 64;
    output_tensors_cpu_Subgraphs_9[0]->dim[3] = 64;
    ...
    int input_size_npu_Subgraphs_40[] = {1 * 320 * 64 * 64, 1 * 320 * 64 * 64, };
    ...
    input_tensors_npu_Subgraphs_40[0]->dim[2] = 64;
    input_tensors_npu_Subgraphs_40[0]->dim[3] = 64;
    ...
    input_tensors_npu_Subgraphs_40[1]->dim[2] = 64;
    input_tensors_npu_Subgraphs_40[1]->dim[3] = 64;
    ...
    output_tensors_npu_Subgraphs_40[0]->dim[2] = 40960;
    ...
    int input_size_npu_Subgraphs_41[] = {1 * 32 * 40960, };
    ...
    input_tensors_npu_Subgraphs_41[0]->dim[2] = 40960;
    ...
    output_tensors_npu_Subgraphs_41[0]->dim[2] = 64;
    output_tensors_npu_Subgraphs_41[0]->dim[3] = 64;
...
// printf("-----------npu_Subgraphs_16------------\r\n");
        ...
        float* concat_result_1 = (float*)malloc(1 * 1920 * 16 * 16 * sizeof(float));
        concat(output_tensors_npu_Subgraphs_16[0]->data, 1, 1280, 16, 16, output_tensors_npu_Subgraphs_8[1]->data, 640, concat_result_1, 1920);
        float *reshape_output_1 = (float *)malloc(1 * 32 * 15360 * sizeof(float));
        reshape(concat_result_1, reshape_output_1, 1, 1920, 16, 16, 32, 15360);
...
// printf("-----------npu_Subgraphs_20------------\r\n");
        ...
        float* concat_result_2 = (float*)malloc(1 * 1920 * 32 * 32 * sizeof(float));
        concat(output_tensors_npu_Subgraphs_20[0]->data, 1, 1280, 32, 32, output_tensors_npu_Subgraphs_8[0]->data, 640, concat_result_2, 1920);
        float *reshape_output_2 = (float *)malloc(1 * 32 * 61440 * sizeof(float));
        reshape(concat_result_2, reshape_output_2, 1, 1920, 32, 32, 32, 61440);
...
// printf("-----------npu_Subgraphs_22------------\r\n");
        ...
        float *add_result_1 = (float *)malloc(1 * 640 * 32 * 32 * sizeof(float));
        add_arrays(output_tensors_npu_Subgraphs_22[0]->data, output_tensors_npu_Subgraphs_21[0]->data, add_result_1, 1, 640, 32, 32);
        float *reshape_output_3 = (float *)malloc(1 * 32 * 20480 * sizeof(float));
        reshape(add_result_1, reshape_output_3, 1, 640, 32, 32, 32, 20480);
...
// printf("-----------npu_Subgraphs_25------------\r\n");
        ...
        float* concat_result_3 = (float*)malloc(1 * 960 * 32 * 32 * sizeof(float));
        concat(output_tensors_npu_Subgraphs_25[0]->data, 1, 640, 32, 32, output_tensors_npu_Subgraphs_4[1]->data, 320, concat_result_3, 960);
        float *reshape_output_4 = (float *)malloc(1 * 32 * 30720 * sizeof(float));
        reshape(concat_result_3, reshape_output_4, 1, 960, 32, 32, 32, 30720);
...
// printf("-----------npu_Subgraphs_27------------\r\n");
        ...
        float *add_result_2 = (float *)malloc(1 * 640 * 32 * 32 * sizeof(float));
        add_arrays(output_tensors_npu_Subgraphs_27[0]->data, output_tensors_npu_Subgraphs_26[0]->data, add_result_2, 1, 640, 32, 32);
        float *reshape_output_5 = (float *)malloc(1 * 32 * 20480 * sizeof(float));
        reshape(add_result_2, reshape_output_5, 1, 640, 32, 32, 32, 20480);
...
// printf("-----------npu_Subgraphs_30------------\r\n");
        ...
        float* concat_result_4 = (float*)malloc(1 * 960 * 64 * 64 * sizeof(float));
        concat(output_tensors_npu_Subgraphs_30[0]->data, 1, 640, 64, 64, output_tensors_npu_Subgraphs_4[0]->data, 320, concat_result_4, 960);
        float *reshape_output_6 = (float *)malloc(1 * 32 * 122880 * sizeof(float));
        reshape(concat_result_4, reshape_output_6, 1, 960, 64, 64, 32, 122880);
...
// printf("-----------npu_Subgraphs_32------------\r\n");
        ...
        float *add_result_3 = (float *)malloc(1 * 320 * 64 * 64 * sizeof(float));
        add_arrays(output_tensors_npu_Subgraphs_32[0]->data, output_tensors_npu_Subgraphs_31[0]->data, add_result_3, 1, 320, 64, 64);
        float *reshape_output_7 = (float *)malloc(1 * 32 * 40960 * sizeof(float));
        reshape(add_result_3, reshape_output_7, 1, 320, 64, 64, 32, 40960);
...
// printf("-----------npu_Subgraphs_35------------\r\n");
        ...
        float* concat_result_5 = (float*)malloc(1 * 640 * 64 * 64 * sizeof(float));
        concat(output_tensors_npu_Subgraphs_35[0]->data, 1, 320, 64, 64, output_tensors_npu_Subgraphs_0[1]->data, 320, concat_result_5, 640);
        float *reshape_output_8 = (float *)malloc(1 * 32 * 81920 * sizeof(float));
        reshape(concat_result_5, reshape_output_8, 1, 640, 64, 64, 32, 81920);
...
// printf("-----------npu_Subgraphs_37------------\r\n");
        ...
        float *add_result_4 = (float *)malloc(1 * 320 * 64 * 64 * sizeof(float));
        add_arrays(output_tensors_npu_Subgraphs_37[0]->data, output_tensors_npu_Subgraphs_36[0]->data, add_result_4, 1, 320, 64, 64);
        float *reshape_output_9 = (float *)malloc(1 * 32 * 40960 * sizeof(float));
        reshape(add_result_4, reshape_output_9, 1, 320, 64, 64, 32, 40960);
