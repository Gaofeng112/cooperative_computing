...
class ModelInference:
    ...
    # def inference(self, initial_input_data,output_names_list=None):
    ...
    #                 if(output_name in output_names_list):
    #                     collected_outputs[output_name] = output
